...
- You can leverage [\Magento\Authorization\Model\Acl\AclRetriever](https://github.com/magento/magento2/blob/2.4-develop/app/code/Magento/Authorization/Model/Acl/AclRetriever.php).  That has a few methods that will help
